...
## Senior
- Proficient with workflows inside test management tools, including custom workflow configuration and permissions assignment (Task-management, Test Case Management, Defect Management tools). Able to replicate a real project lifecycle within those tools.
